...
<body>
    <?php
    $connect = mysqli_connect('127.0.0.1','root', 'rr3312bk', 'webdb',3307);
    $number = $_GET['number'];  // GET 방식 사용
    session_start();
    $query = "select title, content, date, views, id from board where number = $number";
    ...
    <table class="read_table" align=center>
        ...
        <tr>
            ...
            <td class="read_hit2"><?php echo $rows['views'] + 1 ?></td>
        </tr>
